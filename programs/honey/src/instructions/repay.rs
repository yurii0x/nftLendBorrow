...
pub struct Repay<'info> {
    ...
    /// CHECK: TODO what should we be checking
    #[account(mut)]
...
pub trait RepayContext<'info> {
    ...
    fn obligation(&self) -> &AccountLoader<'info, Obligation>;
    fn reserve(&self) -> &AccountLoader<'info, Reserve>;
...
pub fn repay<'info, T: RepayContext<'info>>(ctx: &Context<T>, amount: Amount) -> Result<()> {
